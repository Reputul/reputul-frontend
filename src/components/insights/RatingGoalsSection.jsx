            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 rounded-xl">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`px-4 py-2 rounded-lg bg-gradient-to-r ${getBadgeGradient(
              ...
              <div className="p-4 bg-gray-50 rounded-xl">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-3xl font-bold text-gray-900">
                    {reputationMetrics.wilsonScore.toFixed(2)}
                  </span>
                </div>
              </div>
            </div>
                ...
                <div key={index} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-semibold text-gray-600">
                      {isAchieved ? (
                        ...
                        `+ ${goal.reviewsNeeded.toLocaleString()} more 5⭐ reviews`
                      )}
                    </span>
                  </div>
                  ...
                  <div className="relative">
                    <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
                      ...
                      >
                        {/* Shimmer effect - using custom CSS class */}
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-1">
                  Focus on requesting reviews from satisfied customers to reach
                  your rating goals faster!
                </p>
              </div>
            </div>
          </div>
