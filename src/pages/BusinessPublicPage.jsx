      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Fetching the latest reviews and information...
          </p>
        </div>
      </div>
    );
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 lg:py-24">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-6">
              {business.badge && (
                <span
                  className={`px-6 py-3 text-sm font-bold rounded-full ${getBadgeColor(
                    business.badge
                  )} animate-pulse`}
                >
                  <svg
              ...
              <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-50 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-gray-600 text-lg">
                    {business.phone || "Contact information not provided"}
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  {business.website ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-blue-600 hover:text-blue-800 underline text-lg transition-colors"
                    >
                      {business.website}
                    </a>
                  ) : (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-50 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-gray-600 text-lg">
                    {business.reputationScore || averageRating}/5.0
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {[5, 4, 3, 2, 1].map((rating) => (
                <div key={rating} className="flex items-center space-x-6">
                  ...
                  <div className="flex-1 bg-gray-200 rounded-full h-4 overflow-hidden shadow-inner">
                    <div
                      ...
                      style={{
                        width: `${
                          reviews.length > 0
                            ? (ratingDistribution[rating] / reviews.length) *
                              100
                            : 0
                        }%`,
                      }}
                  ...
                  <span className="w-12 text-lg font-semibold text-gray-600">
          ...
          {reviews.length === 0 ? (
            ...
            <div className="space-y-6 max-h-[600px] overflow-y-auto pr-2">
              {getFilteredAndSortedReviews().map((review, index) => (
                <div
                  key={review.id}
                  className="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-100 rounded-2xl p-8 hover:shadow-xl hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-1"
                >
                  <div className="flex items-start space-x-6">
                    {/* Customer Avatar */}
                    <div
                      className={`w-16 h-16 rounded-2xl ${getRandomColor(
                        index
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                {[1, 2, 3, 4, 5].map((rating) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setNewReview({ ...newReview, rating: rating.toString() })
                    }
